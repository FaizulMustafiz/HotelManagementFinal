...
namespace HotelManagementFinal.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomTypeId,RoomTypeName")] RoomType roomType)
        {
            ...
            {
                if (!db.RoomTypes.Any(x => x.RoomTypeName == roomType.RoomTypeName))
                {
                    db.RoomTypes.Add(roomType);
                    db.SaveChanges();
                    TempData["success"] = "Room Type Successfully Saved";
        ...
        public JsonResult CheckName(string RoomTypeName)
        {
            return Json(!db.RoomTypes.Any(x => x.RoomTypeName == RoomTypeName), JsonRequestBehavior.AllowGet);
        }
    }
}
